 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://impl.webservice.demo.com/", wsdlLocation = "http://localhost:8090/demo/my?wsdl")
@Component
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://impl.webservice.demo.com/", "MyServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/demo/my?wsdl");
    ...
    public MyService getMyServiceImplPort() {
        return super.getPort(new QName("http://impl.webservice.demo.com/", "MyServiceImplPort"), MyService.class);
    }
    ...
    public MyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.webservice.demo.com/", "MyServiceImplPort"), MyService.class, features);
    }
